...
class NonClippingDismissible extends StatefulWidget {
  const NonClippingDismissible({
    @required Key key,
    @required this.child,
    this.background,
  ...
  @override
  _NonClippingDismissibleState createState() => _NonClippingDismissibleState();
}

enum _FlingGestureKind { none, forward, reverse }

class _NonClippingDismissibleState extends State<NonClippingDismissible>
